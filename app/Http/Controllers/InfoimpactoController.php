...
class InfoimpactoController extends Controller
{
    public function Infoimpacto(){
        return view('Barra-Navegacion.Programas.informacion.infoimpacto');
    }
    public function store(Request $request)
{
    ...
    $precetfoc = new \App\Models\infoimpactoModel();
