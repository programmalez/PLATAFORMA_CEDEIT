...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('update1', ['id' =>  $proim->id]) }}" method="post"  enctype="multipart/form-data" >
                {{ csrf_field() }}
                {{ method_field('patch') }}
                <div class="row">
                    <!-- Columna 1 -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="curso" name="curso" value=" {{  $proim->curso }} ">
                        </div>

                        <div class="form-group">
                            <label for="licencia"> Licencia de Funcionamiento:</label>
                            <input type="text" class="form-control" id="licencia" name="licencia" value=" {{ $proim->licencia }} ">
                        </div>
                        <div class="form-group">
                            <label for="perfil">Perfil Profesional:</label>
                            <textarea class="form-control" id="perfil" name="perfil" style="width: 100%; height: 200px;" >{{  $proim ->perfil }}</textarea>
                        </div>
                        <label for="cuatri">Cuatrisemestre</label>
                            <select class="form-control" id="cuatri" name="cuatri"  required>
                                <option value="0" {{  $proim ->cuatri == 0 ? 'selected' : '' }}></option>
                                <option value="1" {{  $proim ->cuatri == 1 ? 'selected' : '' }}>1</option>
                                <option value="2" {{  $proim ->cuatri == 2 ? 'selected' : '' }}>2</option>
                                <option value="3" {{  $proim ->cuatri == 3 ? 'selected' : '' }}>3</option>
                            </select>
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    @if( $proim ->imagen)
                                        <p>Imagen actual: {{  $proim->imagen }}</p>
                                    @else
                                ...
                                <div class="form-group">
                                    ...
                                    @if( $proim ->documento)
                                        <p>Documento actual: {{  $proim ->documento }}</p>
                                    @else
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titulo" name="titulo" value=" {{  $proim ->titulo }} ">
                        </div>
                        <div class="form-group">
                            <label for="modalidad">Modalidad:</label>
                            <input type="text" class="form-control" id="modalidad" name="modalidad" value=" {{  $proim ->modalidad }} ">
                        </div>

                        <div class="form-group">
                            <label for="texto">Informacion de Curso:</label>
                            <textarea class="form-control" id="texto" name="texto" style="width: 100%; height: 400px;">{{  $proim->texto }}</textarea>
                        </div>
                    </div>
                </div>
