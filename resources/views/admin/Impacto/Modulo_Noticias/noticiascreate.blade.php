...
@section('content_header')
    <h1 style="margin-bottom: 20px; text-align: center;">Agregar Noticias Impacto al Mundo</h1>
@stop
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
            <div class="col-12 mt-3" id="Tabla_Noticias_Impacto" style="overflow-x: auto;">
                <div class="table-container">
                    <table class="table table-bordered table-striped" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                            $noticias = \App\Models\NoticiasimpactoModel::select('id','nombre','imagen','fecha_publicacion','hora_publicacion','texto','autor','enlace')->get();
                            ?>
                            @foreach ($noticias as $noticia)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('edit_not', ['id' => $noticia->id]) }}" method="get" style="display:inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-warning btn-accion" ><i class="fas fa-pen"></i></button>
                                        </form>
                                        <form action="{{ route('delete_not', ['id' => $noticia->id]) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
