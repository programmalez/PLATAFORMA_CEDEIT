...
@section('content_header')
    <h1 style="margin-bottom: 20px; text-align: center;">Editar Noticias Cedeit</h1>
@stop
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('update_noticia', ['id' => $noticia->id]) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('patch') }}
                ...
                <button type="reset" id="reset" class="btn btn-danger">Atras</button>
            </form>
        </div>
    </div>
</div>
