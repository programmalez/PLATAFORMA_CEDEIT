...
@section('content_header')
    <h1 style="margin-bottom: 20px; text-align: center;">Editar Noticias Cetfoc</h1>
@stop
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('update_no', ['id' => $noticia->id]) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('patch') }}
                <div class="row">
                    <!-- Columna 1 -->
                ...
                <button type="submit" class="btn btn-primary" name="action" value="edit" onclick="alerta2()">Actulizar</button>
