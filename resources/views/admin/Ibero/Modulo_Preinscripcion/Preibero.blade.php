...
@section('content_header')
    <h1 style="margin-bottom: 20px; text-align: center;">Lista de Preinscritos IBEROAMERICANA</h1>
@stop
...
<div class="col-12">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-md-6">
            <p>Total de registros: {{ $totalPreinscritos1 }}</p>
        </div>
    </div>
</div>
...
<div class="col-12 mt-3">
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                @foreach ($Preinscritos1 as $Preins) 
                <tr>
                    ...
                    <td>{!! str_ireplace($query ?? '', '<span class="highlighted-text">' . ($query ?? '') . '</span>', $Preins->documento) !!}</td>
