            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formularioInscripcion" action="{{ route('matricetfoc1') }}" method="post">
                            @csrf
                            ...
                            <div id="datosPersonales">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="celular2" name="celular2"  placeholder="Celular" required>
                                    </div>
                                    <div class="form-group col-md-6">
                            ...
                            <div id="limitacionesCapacidades" style="display: none;">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="describa" name="describa2"  placeholder="Describa" required>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="describa" name="describa3"  placeholder="Describa3" required>
                                </div>
                            ...
                            <div id="programaregistro" style="display: none;">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="programa" name="programa" style="width: 387px; height: 40px; border: 1px solid #d7d3d3; border-radius: 5px;">
                                        ...
                                        $cursos = \App\Models\ProcetModel::pluck('curso');
