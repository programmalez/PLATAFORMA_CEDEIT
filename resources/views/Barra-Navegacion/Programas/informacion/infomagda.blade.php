...
<style>
    ...
    .descargar {
        background-color: #08ac1e !important;
...
<body>
    ...
    <?php
    $progmag = \App\Models\PromagdalenaModel::findOrFail($id);
    ?>
            ...
            <div class="col-3 " style="z-index: 0;">
                ...
                <div class="container">
                    <div class="sidebar">
                        <div class="box">
                            <h2>Facultad</h2>
                            <p>{{ $progmag->facultad }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                            <h2>Programa Académico</h2>
                            <p>{{ $progmag->programa }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                            <h2>Codigo SNIES</h2>
                        ...
                        <div class="box">
                            <h2>Registro calificado</h2>
                            <p>{{ $progmag->registro }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                        ...
                        <div class="box">
                            ...
                            <p>{{ $progmag->creditos }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                            <h2>Nivel de formacion</h2>
                            <p>{{ $progmag->formacion }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                            <h2>Metodologia</h2>
                            <p>{{ $progmag->metodologia }}</p>
                            <div class="line"></div>
                        </div>
                        <div class="box">
                            <h2>Duracion estimada</h2>
                            <p>{{ $progmag->semestre }} Semestres</p>
                            <div class="line"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        <article class="post">
                            <div class="post-header">
                                <h2 style="margin-top: 0px"> {{ $progmag->programa }}</h2>
                                <div class="post-img-1"><img src="{{ asset('Imagenes/' . $progmag->imagen) }}"
                            ...
                            <div class="post-body">
                                ...
                                <div class="box-paragraph">
                                    <p style="text-align: justify;"> {{ $progmag->texto }} </p>
                                </div>
                                <h2>Perfil profesional</h2>
                                <div>
                                    <p style="text-align: justify;"> {{ $progmag->profesional }} </p>
                                </div>
                                <h2>Perfil ocupacional</h2>
                                <p style="text-align: justify;">{{ $progmag->ocupacional }} </p>
                            </div>
                        </article>
                    </div>
                </section>
            ...
            <div class="col-3 ">
                <div class="third-column">
                    <div class="button-container">
                        ...
                        <button type="button" class="btn-custom" style="width: 220px; height: 100px; " data-toggle="modal"
                            data-target="#suscripcionModal">
                            SOLICITAR INFORMACION
                        </button>
                        <a href="{{ asset('Documentos/' . $progmag->documento) }}" class="btn-custom descargar"
                            style="width: 220px; height: 100px; text-decoration: none;" onclick="abrirEnNuevaPestana(event)">
                        ...
                        <div class="modal-dialog " role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="suscripcionModalLabel">Solicitar Información</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('insertarmag') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control ml-2" id="documento" name="documento"
                                                    style="width: 230px;" placeholder="Número de documento" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                $programas = \App\Models\PromagdalenaModel::pluck('programa');
                ...
                <div class="modal fade" id="suscripcionModal2" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <!-- Agregar aquí los campos del formulario (nombre, correo, celular, etc.) -->
                                <form action="{{ route('Matrimagda') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="apellidos">Apellidos:</label>
                                            <input type="text" class="form-control" id="apellidos" name="apellidos"
                                                style="width: 250px;" placeholder="Apellidos" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="documento">Número documento:</label>
                                            <input type="number" class="form-control ml-2" id="documento" name="documento"
                                                style="width: 180px;" placeholder="Número de documento" required>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="institucion" name="institucion"
                                                style="width: 380px;" placeholder="Nombre Institucion" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="instituto2" name="instituto2"
                                                style="width: 380px;" placeholder="Nombre Institucion" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="programa" name="programa" style="width: 347px; height: 40px; border: 1px solid #d7d3d3; border-radius: 5px;">
                                                ...
                                                $programas = \App\Models\PromagdalenaModel::select('id','programa', 'metodologia')->get();
