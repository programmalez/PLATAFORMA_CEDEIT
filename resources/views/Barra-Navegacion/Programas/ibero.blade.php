...
<style>
    ...
    #carouselExampleDark {
        z-index: -1;
        /* Esto colocará el carrusel detrás de otros element*/
    ...
    #carouselExampleSlidesOnly {
        margin-top: -70px;
        /* Ajusta la cantidad que desees para que el carru
    ...
    .post-body p {
        ...
        display: -webkit-box;
        -webkit-line-clamp: 3;
        /* Ajusta el número de líneas según tus necesidades */
        -webkit-box-orient: vertical;
        line-height: 1.5;
        /* Ajusta según el espacio entre líneas deseado */
...
<body>
    ...
    <section id="seccion9">
        <h2 style="color: rgb(148, 122, 5); font-size: 42px; text-align: left; text-align: center;">Oferta Académica </h2>
    </section>
    <section class="post-list">
        <div class="content">
            <?php
            $proibero = \App\Models\ProiberoModel::select('id', 'programa', 'codigo', 'oferta', 'metodologia', 'texto', 'semestre', 'imagen', 'documento')->get();
            ?>
            @foreach ($proibero as $proibe)
                @if ($proibe->id)
                <article class="post" data-nivel="pregrado" data-modalidad="virtual">
                    <div class="post-header">
                        <div class="post-img-2"><img src="{{ asset('Imagenes/' . $proibe->imagen) }}"
                                class="card-img-top img-fluid" alt="Imagen" style="width: 320px; height: 200px;">
                        </div>
                    </div>
                    <div class="post-body">
                        <h2>{{ $proibe->oferta }}</h2>
                        <h2>{{ $proibe->programa }}</h2>
                        <p class="descripcion">{{ $proibe->texto }}</p>
                        <p class="id">{{ $proibe->metodologia }}</p>
                        <p class="id">SNIES:{{ $proibe->codigo }}</p>
                        <p class="id">{{ $proibe->semestre }} Semestres</p>
                        <a href="{{ route('infoibero2', ['id' => $proibe->id]) }}" class="post-link">Info...</a>
                    </div>
                </article>
                @endif
            @endforeach
    ...
    <a href="https://api.whatsapp.com/send?phone=3176424746" class="btn-wsp" target="_blank"><i
        class="icon-whatsapp"></i></a>
    <div class="col-lg-10 col-lg-offset-1 col-md-12">
        <ul class="enlaces" style="display: flex; justify-content: center; list-style: none; padding: 50;">
            <li style="margin: 0 20px;"><a rel="nofollow" href="https://www.ibero.edu.co" title="Iberoamericana"><img
                        src="{{ asset('assets/logoIBERO.png') }}" width="174" height="75" alt=""></a></li>
            <li style="margin: 0 10px;"><a rel="nofollow" href="https://www.unimagdalena.edu.co" title="Magdalena"><img
                        src="assets/Magdalena.jpg" width="124" height="75" alt=""></a></li>
        </ul>
    </div>
    <footer class="footer">
