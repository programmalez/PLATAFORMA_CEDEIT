...
<body>
    ...
    <h1 style="color: rgb(148, 122, 5); font-size: 42px; text-align: left; text-align: center;">Lo que está pasando en IMPACTO </h1>
    <?php
    ...
    @foreach($noticias as $noticia)
        <section class="tile inline-tile">
            ...
            <div class="tile-body">
                ...
                <p>{{ $noticia->texto }}</p>
                <a class="VerMas" title="" href="{{ route('noticmpac+', ['id' => $noticia->id]) }}">Ver más</a>
            </div>
        </section>
    @endforeach
    {{ $noticias->links() }}
