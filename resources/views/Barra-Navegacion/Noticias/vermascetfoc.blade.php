...
<style>
     ...
     .menu-vertical li a{
      ...
      body {
            ...
            .tile-caption a {
                ...
                color: rgb(13, 62, 187) !important;  /* Color del texto */
    ...
    margin-top: -30px; /* Puedes ajustar según sea necesario */
...
<body>
    ...
    <?php
    $noticia = \App\Models\NoticiascetfocModel::findOrFail($id);
    ?>
    <section class="tile inline-tile">
        ...
        <div class="container">
            <nav class="sidebar">
                ...
                <a href="{{ route('noticet') }}">Noticias</a>
            </nav>
        </div>
    </section>
