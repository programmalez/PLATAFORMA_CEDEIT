...
<style>
   ...
   body {
            ...
            .tile-caption a {
                ...
                color: rgb(6, 22, 63) !important;  /* Color del texto */
    ...
    .sidebar {
    width: 130px; /* Ajusta el ancho de la barra lateral según sea necesario */
...
<body>
    <nav>
        <ul class="menu-horizontal">
            ...
            <li>
                <a href="{{ route('conocenos_impacto') }}">Conocenos</a>
            ...
            <li>
                <a href="{{ route('Rimpacto') }}">Admisiones</a>
                <ul class="menu-vertical">
                    <li><a href="{{ route('Rimpacto') }}">Procesos y requisitos para Estudiantes</a></li>
                </ul>
            </li>
            <li>
    ...
    <?php
    $noticia = \App\Models\NoticiasimpactoModel::findOrFail($id);
    ?>
    <section class="tile inline-tile">
        <div class="tile-body">
            ...
            <div class="tile-img">
                <div class="img"><img src="{{ asset('Imagenes/' . $noticia->imagen) }}" class="card-img-top" alt="Imagen" style="width: 900px; height: 500px; "></div>
            </div>
            <p>{{ $noticia->texto }}</p>
        </div>
        <div class="container">
            <nav class="sidebar">
                ...
                <a href="{{ route('noticmpacto') }}">Noticias</a>
            </nav>
        </div>
    </section>
    ...
    <footer class="footer">
        ...
        <div class="container__footer">
            ...
            <div class="box__footer">
                ...
                <a href="{{ route('Rimpacto') }}">Proceso de Matricula</a>
                <a href="{{ route('tecnicolaboral_impacto') }}">Programas</a>
