...
<body>
    <nav>
        <ul class="menu-horizontal">
            ...
            <li><a href="{{route('IMPACTO') }}">Inicio</a></li>
            <li>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item">
                <img src="{{ asset('assets/impactoalmundo.png') }}" class="d-block w-100" alt="Primera Imagen">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('assets/impactoalmundo.png') }}" class="d-block w-100" alt="Segunda Imagen">
            </div>
            <div class="carousel-item active">
                <img src="{{ asset('assets/impactoalmundo.png') }}" class="d-block w-100" alt="Tercera Imagen">
            </div>
        </div>
    </div>
    <section class="post-list">
        <div class="content">
            <h3>Noticias</h3>
            <?php
            $noticias = \App\Models\NoticiasimpactoModel::select('id', 'nombre', 'imagen', 'fecha_publicacion',
            ...
            @foreach($noticias as $noticia)
                <article class="post">
                    ...
                    <div class="post-body">
                        ...
                        <a href="{{ route('noticmpac+', ['id' => $noticia->id]) }}" class="post-link">Ver Más</a>
                    </div>
            </article>
            @endforeach
            <a href="{{ route('noticmpacto') }}" class="post-link" style="color:   rgb(13, 62, 187);"><i class="fas fa-arrow-right" style="color:   rgb(13, 62, 187);"></i>Ver Más Noticias</a>
        </div>
    </section>
    <div class="convenios">
        <div class="content1">
...
<script>//Para mover las imagenes cada 3 segundos pagina Inicio
