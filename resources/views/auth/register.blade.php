                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form  action="{{ route('register') }}" method="post">
                        ...
                        <div class="form-outline mb-4" hidden>
                          <label class="form-label" for="form2Example22">Rol</label>
                          <input type="role" name="role" id="form2Example22" class="form-control" value="host" />
                        </div>
                  ...
                  <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                      <h4 class="mb-4">Centro De Desarrollo Integral y Tecnologico</h4>
                      <p class="small mb-0">Esta empresa fué constituida como SOCIEDAD POR ACCIONES SIMPLIFICADA
                         y se dedica a Educacion media tecnica. Si necesita más información sobre Centro
                        Para El Desarrollo Integral Y Tecnologico Sas regístrese y acceda gratis a más información de la empresa
